!(function (t) {
  ...
  function (t, e, n) {
    ...
    function i(t, e) {
      return { status: "error", target: e, message: t, timestamp: Date.now() };
    }
    var o =
    ...
    AFRAME.registerShader("html", {
      ...
      __updateTexture: function (t) {
        var e = this,
          ...
          o = t.height,
          s = t.ratio;
        (this.__width = i || this.schema.width.default),
          (this.__height = o || this.schema.height.default);
        var a = function () {
          e.__debugEl &&
            ((e.__debugEl.innerHTML = ""),
            (e.__debugEl = e.schema.debug.default));
        };
        if (t.debug) {
        ...
        if (n) {
          ...
          (this.__target = n),
            this.__validateSrc(n, this.__setTexure.bind(this));
        } else this.__reset();
      },
      __validateSrc: function (t, e) {
        ...
        if (r && "object" === ("undefined" == typeof r ? "undefined" : o(r))) {
          if (r.error) n = r.error;
            ...
            "img" === s || "video" === s
              ? (n = "For <" + s + "> element, please use `shader:flat`")
              : e({
                  status: "success",
                  target: t,
                  targetEl: r,
      ...
      __draw: function (t) {
        if ((u("__draw"), this.__ctx && this.__texture)) {
          var e = t.width / t.height,
            n = (this.__cnv.width = THREE.Math.floorPowerOfTwo(t.width)),
            r = (this.__cnv.height = THREE.Math.floorPowerOfTwo(t.height));
          if (
            (this.__ctx.drawImage(t, 0, 0, n, r),
            (this.__texture.needsUpdate = !0),
            this.__ratio)
          ) {
            ...
            this.el.setAttribute(
              "geometry",
              Object.assign({}, this.el.getAttribute("geometry"), {
          ...
          this.__debugEl &&
            ((this.__debugEl.innerHTML = ""), this.__debugEl.appendChild(t)),
            this.__setNextTick();
        }
      },
      __render: function () {
    ...
    var n = function t() {
      t.options.logging &&
        ...
        Function.prototype.bind
          ...
          .apply(
            window.console,
            [Date.now() - t.options.start + "ms", "html2canvas:"].concat(
  ...
  function (t, e, n) {
    ...
    (r.prototype.cloneTo = function (t) {
      ...
      (r.prototype.parseBounds = function () {
        return (
          this.bounds ||
          (this.bounds = this.hasTransform() ? p(this.node) : l(this.node))
        );
      }),
            ...
            function () {
              var t = setInterval(function () {
                n.body.childNodes.length > 0 &&
                  ...
                  clearInterval(t),
                  "view" === a.type &&
                    (l.contentWindow.scrollTo(c, h),
                    !/(iPad|iPhone|iPod)/g.test(navigator.userAgent) ||
                      (l.contentWindow.scrollY === h &&
                        l.contentWindow.scrollX === c) ||
                      ((n.documentElement.style.top = -h + "px"),
  ...
  function (t, e, n) {
    function r(t, e) {
      g++;
      (e = e || {}),
        e.logging && ((d.options.logging = !0), (d.options.start = Date.now())),
        ...
        (e.javascriptEnabled =
          "undefined" != typeof e.javascriptEnabled && e.javascriptEnabled),
        (e.imageTimeout =
          "undefined" == typeof e.imageTimeout ? 1e4 : e.imageTimeout),
        (e.renderer = "function" == typeof e.renderer ? e.renderer : c),
        (e.strict = !!e.strict);
      var n = e.width || 512,
        r = e.height || 512;
        ...
        return function (n, r) {
          ...
          (e.image = i.lowerCanvasEl),
            i
              .setWidth(r.width)
              .setHeight(r.height)
              .add(window.html2canvas.svg.fabric.util.groupSVGElements(n, r))
              .renderAll(),
            t(i.lowerCanvasEl);
        };
      }),
  ...
  function (t, e, n) {
    ...
    function r(t, e, n, r, i) {
      ...
      if (
        (i.background &&
          e.rectangle(0, 0, e.width, e.height, new G(i.background)),
      ...
      (o.visibile = o.isElementVisible()),
        ...
        j("Fetched nodes, total:", this.nodes.length),
        j("Calculate overflow clips"),
        this.calculateOverflowClips(),
        j("Start fetching images"),
        (this.images = r.fetch(this.nodes.filter(S))),
        (this.ready = this.images.ready.then(
          Q(function () {
            return (
              j("Images loaded, starting parsing"),
              j("Creating stacking contexts"),
              this.createStackingContexts(),
              j("Sorting stacking contexts"),
    ...
    function h(t, e, n) {
      var r = t.left,
        ...
        b = s - g;
      return {
        topLeftOuter: c(r, i, a, h).topLeft.subdivide(0.5),
        topLeftInner: c(
          r + n[3].width,
          i + n[0].width,
        ...
        topRightOuter: c(r + m, i, u, l).topRight.subdivide(0.5),
        topRightInner: c(
        ...
        bottomRightOuter: c(r + w, i + y, d, p).bottomRight.subdivide(0.5),
        bottomRightInner: c(
          r + Math.min(w, o - n[3].width),
          i + Math.min(y, s + n[0].width),
          Math.max(0, d - n[1].width),
          p - n[2].width
        ).bottomRight.subdivide(0.5),
        bottomLeftOuter: c(r, i + b, f, g).bottomLeft.subdivide(0.5),
        bottomLeftInner: c(
          r + n[3].width,
          i + b,
    ...
    function D(t) {
      for (var e, n = [], r = 0, i = !1; t.length; )
        F(t[r]) === i
          ...
          : r++,
          r >= t.length &&
            ((e = t.splice(0, r)), e.length && n.push(V.ucs2.encode(e)));
      return n;
    }
    function F(t) {
    ...
    (r.prototype.calculateOverflowClips = function () {
      ...
      (r.prototype.createPseudoHideStyles = function (t) {
        this.createStyles(
          t,
          "." +
            U.prototype.PSEUDO_HIDE_ELEMENT_CLASS_BEFORE +
            ':before { content: "" !important; display: none !important; }.' +
            U.prototype.PSEUDO_HIDE_ELEMENT_CLASS_AFTER +
      ...
      (r.prototype.getPseudoElement = function (t, e) {
        ...
        for (
          var r = M(n.content),
            i = "url" === r.substr(0, 3),
            s = document.createElement(i ? "img" : "html2canvaspseudoelement"),
            a = new U(s, t, e),
            c = n.length - 1;
          c >= 0;
          c--
      ...
      (r.prototype.getChildren = function (t) {
        return B(
          [].filter.call(t.node.childNodes, x).map(function (e) {
            var n = [
              e.nodeType === Node.TEXT_NODE ? new z(e, t) : new W(e, t),
            ].filter(N);
        ...
        e.concat(i)
          ...
          .forEach(function (t) {
            this.renderQueue.push(t),
              y(t) && (this.parse(t), this.renderQueue.push(new s()));
          }, this);
      }),
      (r.prototype.paint = function (t) {
        try {
          t instanceof s
            ...
            : R(t)
            ? (I(t.parent) && t.parent.appendToDOM(),
              this.paintText(t),
              I(t.parent) && t.parent.cleanDOM())
            : this.paintNode(t);
        } catch (t) {
      ...
      (r.prototype.paintFormValue = function (t) {
        ...
        if (e.length > 0) {
          ...
          (r.style.position = "fixed"),
            ...
            this.paintText(new z(r.firstChild, t)),
      ...
      (r.prototype.paintText = function (t) {
        ...
        var e = V.ucs2.decode(t.node.data),
          n =
            (this.options.letterRendering && !b(t)) || H(t.node.data)
              ? e.map(function (t) {
      ...
      (r.prototype.parseBackgroundClip = function (t, e, n, r, i) {
        ...
        switch (o) {
          ...
          case "padding-box":
            ...
            break;
          default:
            d(s, r[0], r[1], e.topLeftOuter, e.topRightOuter, i.left, i.top),
              d(
                s,
                r[1],
                r[2],
        ...
        r.reverse().forEach(function (r, o, s) {
          switch (r.method) {
            case "url":
              ...
              a
                ? this.renderBackgroundRepeating(t, e, a, s.length - (o + 1), n)
      ...
      !(function (o) {
        ...
        function f(t) {
          ...
          for (n = t.lastIndexOf(I), n < 0 && (n = 0), r = 0; r < n; ++r)
            t.charCodeAt(r) >= 128 && s("not-basic"), g.push(t.charCodeAt(r));
          for (i = n > 0 ? n + 1 : 0; i < m; ) {
            for (
              o = y, a = 1, c = x;
              i >= m && s("invalid-input"),
                (h = l(t.charCodeAt(i++))),
                (h >= x || h > N((v - y) / a)) && s("overflow"),
                (y += h * a),
                (d = c <= b ? _ : c >= b + E ? E : c - b),
                !(h < d);
              c += x
            )
              (f = x - d), a > N(v / f) && s("overflow"), (a *= f);
            (e = g.length + 1),
              (b = p(y - o, e, 0 == o)),
              N(y / e) > v - w && s("overflow"),
              (w += N(y / e)),
              (y %= e),
              g.splice(y++, 0, w);
          }
        ...
        function g(t) {
          var e,
            ...
            b,
            T = [];
          for (t = h(t), m = t.length, e = S, n = 0, o = C, a = 0; a < m; ++a)
            (g = t[a]), g < 128 && T.push(B(g));
          for (r = i = T.length, i && T.push(I); r < m; ) {
            for (c = v, a = 0; a < m; ++a)
              (g = t[a]), g >= e && g < c && (c = g);
            for (
              y = r + 1,
                c - e > N((v - n) / y) && s("overflow"),
                n += (c - e) * y,
                e = c,
                a = 0;
              a < m;
